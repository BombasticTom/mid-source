...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance = new Character(titleJSON.gfx, titleJSON.gfy, 'title');
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('newgrounds_mid_logo'));
		add(ngSpr);
		ngSpr.visible = false;
