...
class Glitch
{
	...
	public var iTime(default, set):Float;
	...
	public function new(iTime:Float = 0)
	{
		this.iTime = iTime;
	}
...
class GlitchShader extends FlxShader
{
	@:glFragmentSource('
		...
		/*
			...
			Code provided by CosmicOnsnap
			Edited and ported to Psych Engine by BombasticTom
		*/
		...
		void main()
		{
			...
			vec2 uv = gl_FragCoord.xy / openfl_TextureSize.xy;
			vec2 uvn = uv;
			vec3 col = vec3( 0.0 );
